...
![**My flowchart of the craps game**](figure/myflowchart.png)
...
| Roll_Number | Dice_Total | Phase    | Point_Value | Outcome_of_Roll | Match_Outcome |
|-------------|------------|----------|-------------|-----------------|---------------|
| 1           | 5          | Come_Out | NA          | Point Set       | Win           |
| 2           | 5          | Point    | 5           | Point Hit       | Win           |
...
| Number_of_Rolls | Match_Outcome | Point_Value |
|-----------------|---------------|-------------|
| 1               | Loss          | NA          |
...
simulate_craps_game <- function() {
  # Input: None
  # Output:a dataframe containing the relevant columns
  # Description: This contains all the necessary codes for simulating craps game
}
```
...
summarize_craps_game <- function() {
  # Input: the dataframe of a single craps game from the prior code
  # Output: A dataframe containing a single row which summarizes a game of craps
  # Description: This function will take the output and then summarize the main aspects of the game
}
```
...
run_craps_simulation <- function(N) {
  ...
  # Output: a function which is similar to the summarize_craps game function
  # Description:this function will use the above two functions to simulate and then summarize games
}
```
